...
$.extend(Controller, {
    ...
    mousedown: function (event) {
        ...
        if (this.isStartPos(gridX, gridY))
            this.current !== 'finished' ? this.start() : this.restart();
        else if (this.isEndPos(gridX, gridY))
            this.reset();
        else if (this.can('dragStart') && this.isStartPos(gridX, gridY))
            this.dragStart();
        else if (this.can('dragEnd') && this.isEndPos(gridX, gridY))
            this.dragEnd();
        else if (this.can('drawWall') && grid.isWalkableAt(gridX, gridY))
